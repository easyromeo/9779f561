<!-- eslint-disable vue/no-mutating-props --><!-- eslint-disable linebreak-style -->
    ...
    <aside class="filter">
        ...
        <form class="filter__form form" action="#" method="get" @submit.prevent="submit">
            ...
            <fieldset class="form__block">
                ...
                <ul class="colors">
                    <li class="colors__item" v-for="colorId in colors" :key="colorId.id">
                        <label class="colors__label">
                            <input class="colors__radio sr-only" type="radio" name="color" v-model.number="currentColorId" :value="colorId.id">
                            <span class="colors__value" :style="{ backgroundColor: colorId.code }">
                            </span>
                        </label>
                    </li>
